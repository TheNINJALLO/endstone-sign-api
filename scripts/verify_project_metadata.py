...
expect(release == "0.2.0-alpha.1", "SOURCE_RELEASE version")
...
expect('version = "0.2.0a1"' in pyproject, "Python project version")
expect('__version__ = "0.2.0a1"' in init, "Python package version")
expect('__service_name__ = "endstone:sign:v2"' in init, "Python service name")
expect('__service_abi__ = 2' in init, "Python service ABI")
expect('ReleaseVersion = "0.2.0-alpha.1"' in version_header, "C++ release version")
...
expect("v0.2.0-alpha.1" in readme, "README release tag")
