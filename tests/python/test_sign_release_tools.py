...
class SignReleaseToolTests(unittest.TestCase):
    ...
    def add_fake_stage(stage: Path) -> None:
        ...
        wheel = stage / "plugins" / "endstone_sign_tester-0.2.1a2-cp314-cp314-win_amd64.whl"
        dist_info = "endstone_sign_tester-0.2.1a2.dist-info"
        files = {
    ...
    def test_package_release_creates_exact_assets_and_manifest(self) -> None:
        ...
        with tempfile.TemporaryDirectory(dir=scratch) as temporary:
            ...
            expected = {
                ...
                f"{stem}.zip",
                f"{stem}.sha256",
                "endstone_sign_tester-0.2.1a2-cp314-cp314-win_amd64.whl",
            }
