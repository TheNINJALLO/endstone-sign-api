...
expect(release == "0.2.0-alpha.6", "SOURCE_RELEASE version")
...
expect('version = "0.2.0a6"' in pyproject, "Python project version")
expect('__version__ = "0.2.0a6"' in init, "Python package version")
expect('version = "0.2.0a6"' in tester_pyproject, "tester wheel version")
expect('version = "0.2.0a6"' in tester_plugin, "tester plugin version")
expect('module.attr("__version__") = "0.2.0a6"' in live_bindings,
       "live bridge version")
...
expect('ReleaseVersion = "0.2.0-alpha.6"' in version_header, "C++ release version")
...
expect("v0.2.0-alpha.6" in readme, "README release tag")
...
expect("RELEASE_VERSION: 0.2.0-alpha.6" in workflow, "CI release version")
expect("RELEASE_VERSION: 0.2.0-alpha.6" in release_workflow,
