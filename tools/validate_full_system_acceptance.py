#!/usr/bin/env python3
"""Validate one platform's strict alpha.7 full-system qualification evidence."""
...
EXPECTED_TESTER_WHEEL = {
    "linux-x64": "endstone_sign_tester-0.2.0a7-cp314-cp314-linux_x86_64.whl",
    "windows-x64": "endstone_sign_tester-0.2.0a7-cp314-cp314-win_amd64.whl",
}
