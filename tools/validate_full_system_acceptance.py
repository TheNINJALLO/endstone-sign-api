#!/usr/bin/env python3
"""Validate one platform's strict optional complete-control evidence."""
...
EXPECTED_TESTER_WHEEL = {
    "linux-x64": "endstone_sign_tester-0.2.1a3-cp314-cp314-linux_x86_64.whl",
    "windows-x64": "endstone_sign_tester-0.2.1a3-cp314-cp314-win_amd64.whl",
}
